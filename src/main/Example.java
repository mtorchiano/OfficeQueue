...
public class Example {
    ...
    public static void main(String[] args) throws QueueException {
        ...
        System.out.println("Request types: " + postOffice.getRequestTypes()); // [Other,  Packages, Savings] in any order
        ...
        System.out.println("Counters: " + postOffice.getCounters()); // [P1, P2, S1, S2, S3]  in any order
        ...
        System.out.println("Queues: " + postOffice.queueLengths() );  // {Savings=4, Packages=4, Other=2}
        ...
        System.out.println("Served: " +  postOffice.servedByCounter() ); // {P1={Packages=2}, P2={Packages=2}, S1={Savings=1}, S2={Savings=1, Other=1}}
    }
